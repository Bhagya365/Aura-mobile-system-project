...
public class Purchase_Bills extends javax.swing.JFrame {
    ...
    public Purchase_Bills() {
        ...
        try {            
            ResultSet rs = DBC.search("SELECT * FROM purchase_bill");
            while(rs.next()) {
                ...
                dtm.insertRow(dtm.getRowCount(), new Object[]{id,dt,b,di,t});
            }           
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 224, 149, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(398, 224, 191, -1));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(758, 676, 153, 36));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 676, 153, 36));

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("0000/00/00");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(432, 678, 140, 39));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(688, 224, 154, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/Customer Details Bill.png"))); // NOI18N
        ...
        jLabel2.setText("Purchase Bills");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        //combo
        try {
            ResultSet rs = DBC.search("SELECT * FROM purchase_bill WHERE `distributor` ='"+String.valueOf(jComboBox1.getSelectedItem())+"' ");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            while(rs.next()){
                String id = rs.getString("id");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {           
            ...
            DBC.iud("UPDATE purchase_bill SET `date`= '"+dt+"', `bill`='"+b+"',`distributor`= '"+di+"', `total`='"+t+"' WHERE `id` ='"+id+"'");           
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            int r = jTable1.getSelectedRow();
            String id = String.valueOf(jTable1.getValueAt(r,0));
            DBC.iud("DELETE FROM purchase_bill WHERE `id` = '"+id+"' ");
            DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
            dtm.removeRow(r);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        // print button
        MessageFormat header = new MessageFormat("Search Result Overview of Purchase_Bills");
