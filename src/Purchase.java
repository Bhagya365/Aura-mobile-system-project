...
public class Purchase extends javax.swing.JFrame {
    ...
    public Purchase() {
        ...
        try {            
            ResultSet rs = DBC.search("SELECT * FROM purchase");
            while(rs.next()) {
                String id = rs.getString("id");
                String dt = rs.getString("date");
                String b = rs.getString("bill");
                String di = rs.getString("distributor");                             //db to tble
                String br = rs.getString("brand");
                String m = rs.getString("model");
                String c = rs.getString("code");
                String q = rs.getString("qty");
                String by = rs.getString("buy");                            
                String s = rs.getString("sell");
                String t = rs.getString("total");
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                dtm.insertRow(dtm.getRowCount(), new Object[]{id,dt,b,di,br,m,c,q,by,s,t});
            }           
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/purchase.png"))); // NOI18N
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 121, 217, 36));
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(258, 172, 655, 36));

        jLabel6.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("DISTRIBUTOR");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 171, 217, 36));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(258, 122, 655, 36));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 226, 145, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 226, 165, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 281, 910, 390));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(772, 678, 153, 36));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 678, 153, 36));

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("0000/00/00");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(403, 681, 140, 36));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(665, 226, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/123456.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/123456.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {           
            ...
            String di = String.valueOf(jTable1.getValueAt(r,3));
            String br = String.valueOf(jTable1.getValueAt(r,4));
            String m = String.valueOf(jTable1.getValueAt(r,5));
            String c = String.valueOf(jTable1.getValueAt(r,6));
            String q = String.valueOf(jTable1.getValueAt(r,7));
            String by = String.valueOf(jTable1.getValueAt(r,8));
            String s = String.valueOf(jTable1.getValueAt(r,9));
            String t = String.valueOf(jTable1.getValueAt(r,10));
            DBC.iud("UPDATE purchase SET `date`= '"+dt+"', `bill`='"+b+"' , `distributor`= '"+di+"', `brand`='"+br+"',`model`= '"+m+"', `code`='"+c+"' , `qty`= '"+q+"', `buy`='"+by+"', `sell`='"+s+"', `total`='"+t+"' WHERE `id` ='"+id+"'");           
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        // print button
        MessageFormat header = new MessageFormat("Search Result Overview of Purchase");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            int r = jTable1.getSelectedRow();
            String id = String.valueOf(jTable1.getValueAt(r,0));
            DBC.iud("DELETE FROM purchase WHERE `id` = '"+id+"' ");
            DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
            dtm.removeRow(r);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
            ResultSet rs = DBC.search("SELECT * FROM purchase WHERE `distributor` = '"+n+"'");
            dtm.setRowCount(0);
            while (rs.next()) {                
                String id = rs.getString("id");
                String dt = rs.getString("date");
