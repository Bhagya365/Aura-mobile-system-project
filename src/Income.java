...
public class Income extends javax.swing.JFrame {
    ...
    public Income() {
        ...
        try {            
            ResultSet rs = DBC.search("SELECT * FROM income");
            while(rs.next()) {
                String id = rs.getString("id");
                String dt = rs.getString("date");
                String b = rs.getString("bill");
                String c = rs.getString("customer");                             //db to tble
                String in = rs.getString("income");
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                dtm.insertRow(dtm.getRowCount(), new Object[]{id,dt,b,c,String.valueOf(in)});
            }           
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        for (int i = 0; i < jTable1.getRowCount(); i++) {
           sum = sum + Integer.parseInt(jTable1.getValueAt(i, 4).toString());                //total cost
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(139, 220, 136, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 220, 188, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 275, 926, 396));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(763, 678, 159, 36));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 678, 172, 36));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(219, 682, 130, 34));

        jLabel3.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("0");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(351, 682, 210, 34));

        jLabel9.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("0000/00/00");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 680, 140, 36));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 220, 144, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/salary.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/123456.png"))); // NOI18N
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            ResultSet rs = DBC.search("SELECT * FROM income WHERE `customer` ='"+n+"' ");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            jLabel3.setText(" "); 
            double finc = 0;
            ...
            dtm.insertRow(dtm.getRowCount(), new Object[]{id,dt,b,c,i});
            finc = finc + Double.parseDouble(i);
            jLabel3.setText("Rs "+String.valueOf(finc));
            }
        } catch (Exception e) {
        }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        // print button
        MessageFormat header = new MessageFormat("Search Result Overview of Income");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            DBC.iud("DELETE FROM income WHERE `id` = '"+id+"' ");
            DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
            dtm.removeRow(r);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {           
            ...
            String c = String.valueOf(jTable1.getValueAt(r,3));
            String i = String.valueOf(jTable1.getValueAt(r,4));
            DBC.iud("UPDATE income SET `date`= '"+dt+"', `bill`='"+b+"' , `customer`= '"+c+"',  `income`='"+i+"' WHERE `id` ='"+id+"'");           
