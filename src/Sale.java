...
public class Sale extends javax.swing.JFrame {
    ...
    public Sale() {
        ...
        try {            
            ResultSet rs = DBC.search("SELECT * FROM sale");
            while(rs.next()) {
                ...
                dtm.insertRow(dtm.getRowCount(), new Object[]{id,dt,b,cu,br,m,c,q,by,s,p,t});
            }           
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(191, 224, 139, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(422, 224, 165, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 279, 927, 390));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(735, 676, 153, 36));
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 676, 153, 36));

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("0000/00/00");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 680, 140, 39));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(696, 224, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/Billing/billing.png"))); // NOI18N
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        // print button
        MessageFormat header = new MessageFormat("Search Result Overview of Sale");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            DBC.iud("DELETE FROM sale WHERE `id` = '"+id+"' ");
            DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
            dtm.removeRow(r);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {           
            ...
            String p = String.valueOf(jTable1.getValueAt(r,10));
            String t = String.valueOf(jTable1.getValueAt(r,11));
            DBC.iud("UPDATE purchase SET `date`= '"+dt+"', `bill`='"+b+"' , `customer`= '"+cu+"', `brand`='"+br+"',`model`= '"+m+"', `code`='"+c+"' , `qty`= '"+q+"', `buy`='"+by+"', `sell`='"+s+"', `price`='"+p+"', `total`='"+t+"' WHERE `id` ='"+id+"'");           
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        //combo
        try {
            ResultSet rs = DBC.search("SELECT * FROM sale WHERE `customer` ='"+String.valueOf(jComboBox1.getSelectedItem())+"' ");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            while(rs.next()){
                String id = rs.getString("id");
